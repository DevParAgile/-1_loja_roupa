 ...
 * @author samue
 */
public class V_CadastroFornecedor extends javax.swing.JFrame {

    /**
     * Creates new form V_CadastroProduto
     */
    public V_CadastroFornecedor() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_CadastroFornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new V_CadastroFornecedor().setVisible(true);
            }
        });
    }
